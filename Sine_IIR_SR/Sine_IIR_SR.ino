// IIR filter sine wave oscillator tuned of samplerate timer - pin PD0 audio PWM output //
...
void loop() {
	...
	int sr_tune = 440 * random(10, 100);

	Timer.setOverflow(sr_tune, HERTZ_FORMAT);
