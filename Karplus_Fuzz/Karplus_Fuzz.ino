// floating point Karplus-Strong + fuzz distortion - pin PD0 audio PWM output //
...
float fuzz(float input) { return input - 0.15f * (input * input) - 0.15f * (input * input * input); }
